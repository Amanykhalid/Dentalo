...
// Route::post('/addPatient2', [DentistController::class,'addPatient']);
// Route::post('/addDrug', [DentistController::class,'addDrug']);
// Route::post('/addProcedure', [DentistController::class,'addProcedure']);
// Route::post('/addAppointment/{id}', [DentistController::class,'addAppointment']);
// Route::post('/editAppointment/{id}', [DentistController::class,'editAppointment']);
// Route::post('/editAppointment2/{id}', [DentistController::class,'editAppointment2']);
// Route::post('/editDrug/{id}', [DentistController::class,'editDrug']);
// Route::post('/editProcedure/{id}', [DentistController::class,'editDrug']);
// Route::post('/editPatient/{id}', [DentistController::class,'editPatient']);
...
// Route::post('/deleteDrug/{id}', [DentistController::class,'deleteDrug']);
// Route::post('/deleteappointment', [DentistController::class,'deleteappointment']);
// Route::post('/deletePatient/{id}', [DentistController::class,'deletePatient']);
// Route::post('/deleteProcedure/{id}', [DentistController::class,'deleteProcedure']);
